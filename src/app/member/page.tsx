...
// This file defines a page component that represents the user’s dashboard
// in the members area. This is our first protected route.
// If the user is not authenticated then Next.js will redirect him to the login page.
